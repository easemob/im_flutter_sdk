...
class Cmd(str, Enum):
    ...
    filterConversationsFromDB = "filterConversationsFromDB"
    ...
    sendFCMTokenToServer = "sendFCMTokenToServer"
    sendHonorPushTokenToServer = "sendHonorPushTokenToServer"
    getRTCTokenInfoWithChannelName = "getRTCTokenInfoWithChannelName"
    getUserIdsWithRTCUids = "getUserIdsWithRTCUids"
    saveBlackList = "saveBlackList"
    blockUser = "blockUser"
    unblockUser = "unblockUser"
    fetchGroupBlackList = "fetchGroupBlackList"
    getGroupNamecard = "getGroupNamecard"
    removeUserFromGroup = "removeUserFromGroup"
    updateGroupNamecard = "updateGroupNamecard"
    fetchChatRoomAllAttributesFromServer = "fetchChatRoomAllAttributesFromServer"
    setChatroomAttribute = "setChatroomAttribute"
    setChatroomAttributeForced = "setChatroomAttributeForced"
    removeChatRoomAttributeFromServer = "removeChatRoomAttributeFromServer"
    removeChatRoomAttributeFromServerForced = "removeChatRoomAttributeFromServerForced"
    getUserInfoWithUserId = "getUserInfoWithUserId"
    getUserInfoWithUserIds = "getUserInfoWithUserIds"
    subscribeUsersInfo = "subscribeUsersInfo"
    unsubscribeUsersInfo = "unsubscribeUsersInfo"
    fetchSubscribedUsers = "fetchSubscribedUsers"
    # ---- 5.0 数据同步/会话名/群成员/数据库 ----
    setDataSyncType = "setDataSyncType"
    getDataSyncType = "getDataSyncType"
    ...
    onConversationUnreadMessageCountCleared = "onConversationUnreadMessageCountCleared"
    onAllConversationsUnreadMessageCountCleared = "onAllConversationsUnreadMessageCountCleared"
