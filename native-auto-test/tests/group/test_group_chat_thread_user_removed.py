...
def test_chat_thread_remove_member_updates_member_list(device_a, device_b, assert_api, user_a, user_b):
    ...
    try:
        ...
        if not isinstance(thread_id, str) or not thread_id:
            ...
            with _allure_step("验证创建子区返回的关键字段"):
