...
def test_group_offline_admin_add_remove_final_state(
    ...
    try:
        ...
        _assert_group_event(
            device_b,
            assert_api,
            event_type="onAdminAddedFromGroup",
            group_id=group_id,
        ...
        _assert_group_event(
            device_b,
            assert_api,
            event_type="onAdminRemovedFromGroup",
            group_id=group_id,
            data={"groupId": group_id, "admin": user_b},
        )
...
def test_group_offline_announcement_final_state(
    ...
    try:
        ...
        _assert_group_event(
            device_b,
            assert_api,
            event_type="onAnnouncementChangedFromGroup",
            group_id=group_id,
    ...
    try:
        ...
        for cmd, expected_membership, expected_owner_list in (
            ...
            event_type = (
                ...
                else "onAllowListRemovedFromGroup"
            )
            _assert_group_event(
                device_b,
                assert_api,
...
def test_group_offline_member_attributes_final_state(
    ...
    try:
        ...
        _assert_group_event(
            device_a,
            assert_api,
            event_type="onAttributesChangedOfGroupMember",
            group_id=group_id,
            data={
                "groupId": group_id,
                "userId": user_b,
...
def test_group_offline_shared_file_upload_delete_final_state(
    ...
    try:
        ...
        _assert_group_event(
            device_b,
            assert_api,
            event_type="onSharedFileAddedFromGroup",
            group_id=group_id,
            data={
                "groupId": group_id,
                "sharedFile": {
        ...
        _assert_group_event(
            device_b,
            assert_api,
            event_type="onSharedFileDeletedFromGroup",
            group_id=group_id,
