...
class ChatOptions {
  ...
  /// Can only be set when initializing the SDK with [ChatClient.init], cannot be altered in runtime.
  /// ~end
  ///
  /// ~chinese
  /// WebSocket 服务器地址。
  ///
  /// enableDnsConfig 为 NO 时生效。只能在 [ChatClient.init] 中设置，不能在程序运行过程中动态修改。
  /// ~end
  ...
  @Deprecated('Use [ChatOptions.withAppKey] instead.')
