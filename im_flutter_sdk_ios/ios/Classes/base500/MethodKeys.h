...
static NSString *const ChatFilterConversationsFromDB = @"filterConversationsFromDB";
...
static NSString *const ChatNotifyTokenExpired = @"notifyTokenExpired";
static NSString *const ChatSendFCMTokenToServer = @"sendFCMTokenToServer";
static NSString *const ChatSendHonorPushTokenToServer = @"sendHonorPushTokenToServer";
static NSString *const ChatGetRTCTokenInfoWithChannelName = @"getRTCTokenInfoWithChannelName";
static NSString *const ChatGetUserIdsWithRTCUids = @"getUserIdsWithRTCUids";
static NSString *const ChatSaveBlackList = @"saveBlackList";
static NSString *const ChatBlockUser = @"blockUser";
static NSString *const ChatUnblockUser = @"unblockUser";
static NSString *const ChatFetchGroupBlackList = @"fetchGroupBlackList";
static NSString *const ChatGetGroupNamecard = @"getGroupNamecard";
static NSString *const ChatRemoveUserFromGroup = @"removeUserFromGroup";
static NSString *const ChatUpdateGroupNamecard = @"updateGroupNamecard";
static NSString *const ChatFetchChatRoomAllAttributesFromServer = @"fetchChatRoomAllAttributesFromServer";
static NSString *const ChatSetChatroomAttribute = @"setChatroomAttribute";
static NSString *const ChatSetChatroomAttributeForced = @"setChatroomAttributeForced";
static NSString *const ChatRemoveChatRoomAttributeFromServer = @"removeChatRoomAttributeFromServer";
static NSString *const ChatRemoveChatRoomAttributeFromServerForced = @"removeChatRoomAttributeFromServerForced";
static NSString *const ChatGetUserInfoWithUserId = @"getUserInfoWithUserId";
static NSString *const ChatGetUserInfoWithUserIds = @"getUserInfoWithUserIds";
...
static NSString *const ChatAppendMessage = @"appendMessage";
static NSString *const ChatPinnedMessages = @"pinnedMessages";
