...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    ...
    else if ([ChatAppendMessage isEqualToString:call.method]) {
        [self appendMessage:call.arguments channelName:call.method result:result];
    } else if ([ChatPinnedMessages isEqualToString:call.method]) {
        [self pinnedMessages:call.arguments channelName:call.method result:result];
    }
    else {
