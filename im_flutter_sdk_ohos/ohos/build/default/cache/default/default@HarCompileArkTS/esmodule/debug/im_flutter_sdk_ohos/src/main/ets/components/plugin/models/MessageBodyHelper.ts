import { CmdMessageBody, CombineMessageBody, CombineMessageParams, CustomMessageBody, FileMessageBody, ImageMessageBody, LocationMessageBody, TextMessageBody, VideoMessageBody, VoiceMessageBody, ContentType, } from "@normalized:N&&&@easemob/chatsdk/Index&1.5.3";
import type { ChatMessageBody } from "@normalized:N&&&@easemob/chatsdk/Index&1.5.3";
...
import { GetSafetyValue, IsObj, ObjToMap, SafetyValue } from "@normalized:N&&&im_flutter_sdk_ohos/src/main/ets/components/plugin/SafetyMapTool&1.0.0";
export default class MessageBodyHelper {
    ...
    static localBodyFromJson(json: object): LocationMessageBody {
        ...
        let ret = new LocationMessageBody(latitude, longitude, GetSafetyValue(json, "address"), GetSafetyValue(json, "buildingName"));
        return ret;
    }
