...
import type { ChatError, Presence, PresenceListener } from "@normalized:N&&&@easemob/chatsdk/Index&1.5.3";
...
import { PresenceHelper } from "@normalized:N&&&im_flutter_sdk_ohos/src/main/ets/components/plugin/models/PresenceHelper&1.0.0";
