import 'package:im_flutter_sdk_ohos/src/chat_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/chat_room_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/chat_thread_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/contact_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/group_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/presence_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/push_manager_ohos.dart';
import 'package:im_flutter_sdk_ohos/src/user_info_manager_ohos.dart';
import 'package:im_flutter_sdk_interface/im_flutter_sdk_interface.dart';

class ClientOhos extends Client {
  static void registerWith() {
    Client.instance = ClientOhos();
  }

  ClientOhos() : super();

  final ChatManager _chatManager = ChatManagerOhos();
  final ChatRoomManager _chatRoomManager = ChatRoomManagerOhos();
  final ChatThreadManager _chatThreadManager = ChatThreadManagerOhos();
  final ContactManager _contactManager = ContactManagerOhos();
  final GroupManager _groupManager = GroupManagerOhos();
  final PresenceManager _presenceManager = PresenceManagerOhos();
  final PushManager _pushManager = PushManagerOhos();
  final UserInfoManager _userInfoManager = UserInfoManagerOhos();
  // ignore: unused_field
