...
/// ```
/// ~end
class ChatManagerOhos extends ChatManager {
  ChatManagerOhos() : super();
  ...
  ///
  /// To listen for the status of sending messages, call [ChatManagerOhos.addMessageEvent].
  ///
  ...
  ///
  /// 添加发送状态监听使用 [ChatManagerOhos.addMessageEvent].
  ///
