...
abstract class Client extends PlatformInterface with ManagerMixin {
  ...
  ChatManager get chatManager => ChatManagerDefault();
  ContactManager get contactManager => ContactManagerDefault();
  ChatRoomManager get chatRoomManager => ChatRoomManagerDefault();
  GroupManager get groupManager => GroupManagerDefault();
  PushManager get pushManager => PushManagerDefault();
  UserInfoManager get userInfoManager => UserInfoManagerDefault();
  PresenceManager get presenceManager => PresenceManagerDefault();
  ChatThreadManager get chatThreadManager => ChatThreadManagerDefault();
