...
class OptionsHelper {
    ...
    static EMOptions fromJson(JSONObject json, Context context) throws JSONException {
        ...
        // 5.0 移除 setAutoLogin/setRequireAck
        ...
        // 5.0 setAreaCode 参数改为 AreaCode 枚举
        EMOptions.AreaCode[] areas = {EMOptions.AreaCode.CN, EMOptions.AreaCode.NA, EMOptions.AreaCode.EU,
                EMOptions.AreaCode.AS, EMOptions.AreaCode.JP, EMOptions.AreaCode.IN, EMOptions.AreaCode.GLOB};
        int areaCode = json.optInt("areaCode", 6);
        if (areaCode >= 0 && areaCode < areas.length) {
            options.setAreaCode(areas[areaCode]);
        }
...
class GroupOptionsHelper {
    ...
    static EMGroupConfigs fromJson(JSONObject json) throws JSONException {
        EMGroupConfigs options = new EMGroupConfigs();
    ...
    static Map<String, Object> toJson(EMGroupConfigs options) {
        Map<String, Object> data = new HashMap<>();
        ...
        if (result.getData() != null){
            ...
            for (Object obj : list) {
                ...
                if (obj instanceof EMGroupReadReceipt) {
                    jsonList.add(GroupAckHelper.toJson((EMGroupReadReceipt) obj));
                }
