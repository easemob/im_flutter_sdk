...
public class ChatRoomManagerWrapper extends Wrapper implements MethodChannel.MethodCallHandler {
    ...
    protected boolean dispatchMethodCall(
        ...
        else if (MethodKey.fetchChatRoomAllAttributesFromServer.equals(method)) {
            fetchChatRoomAllAttributesFromServer(params, method, result);
            return true;
        }
        else if (MethodKey.setChatroomAttribute.equals(method)) {
            setChatroomAttribute(params, method, result);
            return true;
        }
        else if (MethodKey.setChatroomAttributeForced.equals(method)) {
            setChatroomAttributeForced(params, method, result);
            return true;
        }
        else if (MethodKey.removeChatRoomAttributeFromServer.equals(method)) {
            removeChatRoomAttributeFromServer(params, method, result);
            return true;
        }
        else if (MethodKey.removeChatRoomAttributeFromServerForced.equals(method)) {
            removeChatRoomAttributeFromServerForced(params, method, result);
            return true;
        }
