...
class _EMChatGroupListPageState extends State<EMChatGroupListPage>
    implements EMChatGroupListItemDelegate {
    ...
    return InkWell(
      onTap: () {
        ...
        EMClient.getInstance().groupManager().createGroup(
            '可直接加入的公开群' + DateTime.now().millisecondsSinceEpoch.toString(),
            '',
            [],
            '',
            EMGroupOptions(
                maxUsers: 2000, style: EMGroupStyle.EMGroupStylePublicOpenJoin),
            onSuccess: (group) {
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Text(
                    DemoLocalizations.of(context).createGroup,
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(padding: EdgeInsets.all(8.0)),
                  Text(
                    DemoLocalizations.of(context).publicGroups,
                    style: TextStyle(fontSize: 18.0),
                  )
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(DemoLocalizations.of(context).chatGroup,
            style: TextStyle(
