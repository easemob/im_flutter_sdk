                        ...
                        actions: <Widget>[
                          ...
                          FlatButton(
                            ...
                            onPressed: () {
                              ...
                              _refreshUI(true);
                              if(_type == Constant.blackList){
                                EMClient.getInstance().groupManager().unblockUser(groupId: _groupId, userName: _members[index],
                                onSuccess: (){
                              ...
                              if(_type == Constant.muteList){
                                EMClient.getInstance().groupManager().unMuteGroupMembers(groupId: _groupId, members: [_members[index]],
                                onSuccess: (group){
                              ...
                              if(_type == Constant.adminList){
                                EMClient.getInstance().groupManager().removeGroupAdmin(groupId: _groupId, admin: _members[index],
                                    onSuccess: (group){
