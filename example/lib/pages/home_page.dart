  ...
  Widget build(BuildContext context) {
    tabbarList = [
      BottomNavigationBarItem(
          ...
          title: new Text(DemoLocalizations.of(context).conversation)),
      BottomNavigationBarItem(
        icon: new Icon(
        ...
        title: new Text(DemoLocalizations.of(context).addressBook),
      ),
      BottomNavigationBarItem(
        icon: new Icon(
          Icons.apps,
        ...
        title: new Text(DemoLocalizations.of(context).find),
      ),
      BottomNavigationBarItem(
        icon: new Icon(
          Icons.face,
        ...
        title: new Text(DemoLocalizations.of(context).mine),
      ),
    ];
    return WillPopScope(
      onWillPop: () async {
