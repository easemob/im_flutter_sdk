...
class ChatManager {
  ...
  /// You can set whether to upload the attachment to the chat sever using [Options.serverTransfer].
  ///
  /// To listen for the status of sending messages, call [ChatManager.addMessageEvent].
  ///
  /// Param [message] The message object to be sent: [Message].
  ///
  ...
  /// 可以使用 [Options.serverTransfer] 设置是否将附件上传到聊天服务器。
  ///
  /// 添加发送状态监听使用 [ChatManager.addMessageEvent].
  ///
  /// Param [message] 需要发送的消息 [Message].
  ///
  ...
  Future<Message> sendMessage(Message message) async {
    ...
    try {
      ...
      Message msg = Message.fromJson(result[ChatMethodKeys.sendMessage]);
  ...
  /// Resends a message.
  ///
  /// Param [message] The message object to be resent: [Message].
  /// ~end
  ///
  /// ~chinese
  /// 重发消息。
  ...
  Future<Message> resendMessage(Message message) async {
    ...
    try {
      Error.hasErrorFromResult(result);
      Message msg = Message.fromJson(result[ChatMethodKeys.resendMessage]);
      message.from = msg.from;
      message.to = msg.to;
      message.status = msg.status;
      return message;
  ...
  ///
  /// **Warning**
  /// This method only takes effect if you set [Options.requireAck] as `true`.
  ///
  /// **Note**
  ...
  ///
  /// Param [message] The message body: [Message].
  ///
  /// **Throws** A description of the exception. See [Error].
  /// ~end
  ///
  ...
  ///
  /// **Warning**
  /// 该方法只有在 [Options.requireAck] 为 `true` 时才生效。
  ///
  /// **Note**
  ...
  /// **Throws** 如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<bool> sendMessageReadAck(Message message) async {
  ...
  ///
  /// **Note**
  /// - This method takes effect only after you set [Options.requireAck] and [Message.needGroupAck] as `true`.
  ...
  ///
  /// **Note**
  /// 1. 使用该方法前，需将 [Options.requireAck] 和 [Message.needGroupAck] 设置为 `true`。
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<Message?> loadMessage(String messageId) async {
    ...
    try {
      ...
      if (result.containsKey(ChatMethodKeys.getMessage)) {
        return Message.fromJson(result[ChatMethodKeys.getMessage]);
      } else {
        return null;
      }
    } on Error catch (e) {
  ...
  /// Param [conversationId] The conversation ID.
  ///
  /// Param [type] The conversation type: [ConversationType].
  ///
  ...
  Future<Conversation?> getConversation(
    ...
    try {
      ...
      if (result[ChatMethodKeys.getConversation] != null) {
        ret = Conversation.fromJson(result[ChatMethodKeys.getConversation]);
      }
      return ret;
    } on Error catch (e) {
      throw e;
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<Conversation?> getThreadConversation(String threadId) async {
    Map result = await ChatChannel.invokeMethod(
    ...
    try {
      ...
      if (result[ChatMethodKeys.getThreadConversation] != null) {
        ret =
            Conversation.fromJson(result[ChatMethodKeys.getThreadConversation]);
      }
      return ret;
    } on Error catch (e) {
      throw e;
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<void> importMessages(List<Message> messages) async {
    List<Map> list = [];
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<void> downloadAttachment(Message message) async {
    Map result = await ChatChannel.invokeMethod(
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<void> downloadThumbnail(Message message) async {
    Map result = await ChatChannel.invokeMethod(
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<void> downloadMessageAttachmentInCombine(Message message) async {
    Map result = await ChatChannel.invokeMethod(
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<void> downloadMessageThumbnailInCombine(Message message) async {
    Map result = await ChatChannel.invokeMethod(
  ...
  Future<List<Conversation>> loadAllConversations() async {
    ...
    try {
      ...
      result[ChatMethodKeys.loadAllConversations]?.forEach((element) {
        conversationList.add(Conversation.fromJson(element));
      });
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<List<Conversation>> getConversationsFromServer() async {
    Map result = await ChatChannel.invokeMethod(
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<List<Conversation>> fetchConversationListFromServer({
    int pageNum = 1,
    int pageSize = 20,
  }) async {
    Map request = {
  ...
  ///
  /// Param [direction] The message search direction. See [SearchDirection].
  ///
  ...
  ///
  /// Param [direction] 要搜索的消息方向. 见 [SearchDirection].
  ///
  /// Param [startMsgId] 获取历史消息的开始消息 ID，如果为空，从最新的消息向前开始获取。
  ///
  /// **Return** 返回消息列表和用于继续获取历史消息的 [CursorResult]
  ///
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<CursorResult<Message>> fetchHistoryMessages({
    ...
    try {
      Error.hasErrorFromResult(result);
      return CursorResult<Message>.fromJson(
  ...
  /// ~end
  Future<CursorResult<Message>> fetchHistoryMessagesByOption(
    String conversationId,
  ...
  ///
  /// Param [direction] The direction in which the message is loaded: SearchDirection.
  /// `SearchDirection.Up`: Gets the messages loaded before the timestamp of the specified message ID.
  /// `SearchDirection.Down`: Gets the messages loaded after the timestamp of the specified message ID.
  ///
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<List<Message>> loadMessagesWithKeyword(
    String keywords, {
    String? sender,
    int timestamp = -1,
    int count = 20,
  ...
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<List<Message>> searchMsgFromDB(
    String keywords, {
    int timestamp = -1,
    int maxCount = 20,
    String from = '',
  ...
  ///
  /// **Return** 返回回执列表和用于下次获取群消息回执的 [CursorResult]
  ///
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<CursorResult<GroupMessageAck>> fetchGroupAcks(
    String msgId,
    String groupId, {
    String? startAckId,
    int pageSize = 0,
    ...
    try {
      Error.hasErrorFromResult(result);
      CursorResult<GroupMessageAck> cursorResult = CursorResult.fromJson(
        result[ChatMethodKeys.asyncFetchGroupAcks],
        dataItemCallback: (map) {
          return GroupMessageAck.fromJson(map);
        },
      );
  ...
  /// Param [conversationId] The conversation ID.
  ///
  /// Param [conversationType] The conversation type. See  [ConversationType].
  ///
  ...
  /// Param [conversationId] 会话 ID。
  ///
  /// Param [conversationType] 会话类型，详见 [ConversationType]。
  ///
  ...
  ///
  /// **Return** The Reaction list under the specified message ID（[MessageReaction.userList] is the summary data, which only contains the information of the first three users）.
  ///
  /// **Throws** A description of the exception. See [Error].
  /// ~end
  ///
  ...
  Future<Map<String, List<MessageReaction>>> fetchReactionList({
    ...
    try {
      Error.hasErrorFromResult(result);
      Map<String, List<MessageReaction>> ret = {};
  ...
  Future<CursorResult<MessageReaction>> fetchReactionDetail({
    ...
    try {
      Error.hasErrorFromResult(result);
      return CursorResult<MessageReaction>.fromJson(
          result[ChatMethodKeys.fetchReactionDetail],
          dataItemCallback: (value) {
        return MessageReaction.fromJson(value);
      });
    } on Error catch (e) {
      throw e;
    }
  ...
  Future<Message> translateMessage({
    ...
    try {
      Error.hasErrorFromResult(result);
      return Message.fromJson(result[ChatMethodKeys.translateMessage]);
    } on Error catch (e) {
      throw e;
    }
  }
  ...
  Future<List<TranslateLanguage>> fetchSupportedLanguages() async {
    ...
    try {
      Error.hasErrorFromResult(result);
      List<TranslateLanguage> list = [];
      result[ChatMethodKeys.fetchSupportLanguages]?.forEach((element) {
        list.add(TranslateLanguage.fromJson(element));
      });
      return list;
    } on Error catch (e) {
      throw e;
  ...
  ///
  /// Param [msgBody]  The modified message body [TextMessageBody].
  ///
  ...
  ///
  /// Param [msgBody] 文本消息体实例 [TextMessageBody]。
  ///
  /// **Return** 修改后的消息实例。
  ///
  /// **Throws**  如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  ...
  Future<Message> modifyMessage({
    ...
    try {
      Error.hasErrorFromResult(result);
      return Message.fromJson(result[ChatMethodKeys.modifyMessage]);
    } on Error catch (e) {
      throw e;
    }
  }
  ...
  /// Throws 如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<CursorResult<Conversation>> fetchConversationsByOptions({
    ...
    try {
      Error.hasErrorFromResult(result);
      return CursorResult<Conversation>.fromJson(
  ...
  Future<void> _onGroupMessageRead(List messages) async {
    List<GroupMessageAck> list = [];
    for (var message in messages) {
      list.add(GroupMessageAck.fromJson(message));
    }
  ...
  Future<void> _messageReactionDidChange(List reactionChangeList) async {
    List<MessageReactionEvent> list = [];
    for (var reactionChange in reactionChangeList) {
      list.add(MessageReactionEvent.fromJson(reactionChange));
    }
  ...
  Future<void> _onMessageContentChanged(dynamic obj) async {
    Message msg = Message.fromJson(obj["message"]);
  ...
  /// **Throws** 如果有异常会在这里抛出，包含错误码和错误描述，详见 [Error]。
  /// ~end
  Future<List<Message>> searchMsgsByOptions(
...
class ChatMessageEvent {
  ...
  /// 消息发送或下载成功回调。
  /// ~end
  final void Function(String msgId, Message msg)? onSuccess;
  ...
  /// ~end
  final void Function(String msgId, Message msg, Error error)? onError;
...
class MessageCallBackManager {
  ...
  MessageCallBackManager._internal() {
    _MessageChannel.setMethodCallHandler((MethodCall call) async {
      ...
      cacheHandleMap.forEach((key, value) {
        if (call.method == ChatMethodKeys.onMessageProgressUpdate) {
          ...
          Message msg = Message.fromJson(argMap['message']);
          Error err = Error.fromJson(argMap['error']);
