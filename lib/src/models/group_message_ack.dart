...
///
/// ```dart
///   CursorResult<GroupMessageAck> result = await Client.getInstance.chatManager.fetchGroupAcks("msgId");
/// ```
/// ~end
///
/// ~chinese
...
class GroupMessageAck {
  ...
  factory GroupMessageAck.fromJson(Map map) {
    GroupMessageAck ack = GroupMessageAck._private(
      ackId: map["ack_id"],
