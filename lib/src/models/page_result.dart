...
/// ~english
/// The PageResult class, which is returned when calling the methods that fetch data by pagination.
...
class PageResult<T> {
  ...
  factory PageResult.fromJson(Map map,
      {dataItemCallback = PageResultCallback}) {
    PageResult<T> result = PageResult<T>._private();
