...
/// ~english
/// The Group class, which contains the information of the chat group.
/// ~end
///
/// ~chinese
/// 群组信息类，包含内存中的群组相关信息。
///
/// **Note**
/// 如需最新数据，需先从服务器获取：[GroupManager.fetchGroupInfoFromServer]。
/// ~end
class Group {
  Group._private({
  ...
  ///
  /// **Note**
  /// To get the correct value, ensure that you call [GroupManager.fetchGroupInfoFromServer] before calling this method.
  /// ~end
  ///
  /// ~chinese
  /// 从内存中获取群组名称。
  ...
  ///
  /// **Note**
  /// To get the correct value, ensure that you call [GroupManager.fetchMemberListFromServer] before calling this method.
  /// ~end
  ///
  /// ~chinese
  /// 从内存中获取群组成员列表。
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[GroupManager.fetchMemberListFromServer]。
  ///
  /// **Return** 群组成员列表。
  /// ~end
  ...
  ///
  /// **Note**
  /// To get the correct value, ensure that you call [GroupManager.fetchBlockListFromServer] before calling this method.
  /// ~end
  ///
  /// ~chinese
  /// 从内存中获取群组黑名单。
  ...
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[GroupManager.fetchBlockListFromServer]。
  ///
  /// 只有群主和管理员可以调用该方法。
  ///
  /// **Return** 群组黑名单。
  ...
  ///
  /// **Note**
  /// To get the correct value, ensure that you call [GroupManager.fetchMuteListFromServer] before calling this method.
  /// ~end
  ///
  /// ~chinese
  /// 从内存中获取群组禁言名单。
  ...
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[GroupManager.fetchMuteListFromServer]。
  ///
  /// **Return** 群组禁言名单。
  /// ~end
  ...
  /// - `false`: No. Users can join freely [GroupStyle.PublicOpenJoin].
  ///
  /// **Note**
  /// There are four types of group properties used to define the style of a group: [GroupStyle].
  ///
  /// **Return**
  ...
  ///
  /// 群组有四个类型属性，`isMemberOnly`是除了 [GroupStyle.PublicOpenJoin] 之外的三种属性，表示该群不是自由加入的群组。
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取： [GroupManager.fetchGroupInfoFromServer]。
  ///
  ...
  GroupOptions? get settings => _options;

  factory Group.fromJson(Map map) {
    ...
    GroupPermissionType? permissionType =
        GroupPermissionType.values[map['permissionType']];
...
class GroupInfo {
  ...
  factory GroupInfo.fromJson(Map map) {
    String groupId = map["groupId"];
    String? groupName = map["name"];
    return GroupInfo._private(
      groupId: groupId,
      name: groupName,
    );
  }
