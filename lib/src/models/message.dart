...
class Message {
  ...
  /// ~english
  /// Message body. See [MessageBody].
  /// ~end
  ///
  /// ~chinese
  /// 消息体。请参见 [MessageBody]。
  /// ~end
  late MessageBody body;
  ...
  /// ~english
  /// Whether the message content is replaced. It is valid after [Options.useReplacedMessageContents] is enabled.
  /// ~end
  /// ~chinese
  /// 消息内容是否被替换, 开启[Options.useReplacedMessageContents]后有效
  /// ~end
  ...
  Future<MessagePinInfo?> pinInfo() async {
    ...
    Map req = {"msgId": msgId};
    Map result = await _MessageChannel.invokeMethod(
  ...
  Message.createSendMessage({
    ...
    this.to,
    this.chatType = ChatType.Chat,
  })  : this.from = Client.getInstance.currentUserId,
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createImageSendMessage({
    required String targetId,
    required String filePath,
    String? displayName,
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createVideoSendMessage({
    required String targetId,
    required String filePath,
    String? displayName,
    int duration = 0,
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createVoiceSendMessage({
    required String targetId,
    required String filePath,
    int duration = 0,
    int? fileSize,
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createLocationSendMessage({
    required String targetId,
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createCustomSendMessage({
    required String targetId,
    required event,
    ...
    ChatType chatType = ChatType.Chat,
            ...
            chatType: chatType,
            to: targetId,
            body: CustomMessageBody(event: event, params: params));
  ...
  /// **Return** 消息体实例。
  /// ~end
  Message.createCombineSendMessage({
    required String targetId,
    String? title,
    String? summary,
  ...
  static MessageBody? _bodyFromMap(Map map) {
    MessageBody? body;
    MessageType type = MessageType.values[map['type']];
    switch (type) {
      case MessageType.TXT:
        body = TextMessageBody.fromJson(map: map);
        break;
      case MessageType.LOCATION:
        body = LocationMessageBody.fromJson(map: map);
        break;
      case MessageType.CMD:
        body = CmdMessageBody.fromJson(map: map);
        break;
      case MessageType.CUSTOM:
        body = CustomMessageBody.fromJson(map: map);
        break;
      case MessageType.FILE:
        body = FileMessageBody.fromJson(map: map);
        break;
      case MessageType.IMAGE:
        body = ImageMessageBody.fromJson(map: map);
        break;
      case MessageType.VIDEO:
        body = VideoMessageBody.fromJson(map: map);
        break;
      case MessageType.VOICE:
        body = VoiceMessageBody.fromJson(map: map);
        break;
  ...
  /// **Return** Reaction 列表。
  ///
  /// **Throws** 如果有方法调用的异常会在这里抛出，可以看到具体错误原因。请参见 [Error]。
  /// ~end
  Future<List<MessageReaction>> reactionList() async {
    Map req = {"msgId": msgId};
    Map result = await _MessageChannel.invokeMethod(
    ...
    try {
      ...
      result[ChatMethodKeys.getReactionList]?.forEach(
        (element) => list.add(
          MessageReaction.fromJson(element),
        ),
      );
      return list;
    } on Error catch (e) {
  ...
  Future<int> groupAckCount() async {
    Map req = {"msgId": msgId};
    Map result =
        await _MessageChannel.invokeMethod(ChatMethodKeys.groupAckCount, req);
    try {
      Error.hasErrorFromResult(result);
  ...
  Future<ChatThread?> chatThread() async {
    Map req = {"msgId": msgId};
    Map result =
        await _MessageChannel.invokeMethod(ChatMethodKeys.getChatThread, req);
    try {
      Error.hasErrorFromResult(result);
...
abstract class MessageBody {
  MessageBody({required this.type});
...
/// 命令消息体类。
/// ~end
class CmdMessageBody extends MessageBody {
  /// ~english
  ...
  /// 创建一个命令消息。
  /// ~end
  CmdMessageBody({required this.action, this.deliverOnlineOnly = false})
      : super(type: MessageType.CMD);

  CmdMessageBody.fromJson({required Map map})
...
class LocationMessageBody extends MessageBody {
  ...
  LocationMessageBody.fromJson({required Map map})
...
/// 图片消息体类。
/// ~end
class ImageMessageBody extends FileMessageBody {
  /// ~english
  ...
  ImageMessageBody.fromJson({required Map map})
...
class TextMessageBody extends MessageBody {
  ...
  TextMessageBody.fromJson({required Map map})
...
/// 视频消息体类。
/// ~end
class VideoMessageBody extends FileMessageBody {
  /// ~english
  ...
  VideoMessageBody.fromJson({required Map map})
...
/// 语音消息体类。
/// ~end
class VoiceMessageBody extends FileMessageBody {
  /// ~english
  ...
  VoiceMessageBody.fromJson({required Map map})
...
/// 自定义消息体类。
/// ~end
class CustomMessageBody extends MessageBody {
  /// ~english
  ...
  CustomMessageBody.fromJson({required Map map})
...
class CombineMessageBody extends MessageBody {
  CombineMessageBody({
    this.title,
    this.summary,
