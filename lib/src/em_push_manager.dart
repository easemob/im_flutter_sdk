...
class EMPushManager{
  ...
  Future<EMImPushConfigs> getImPushConfigs() async {
    Map result = await _emPushManagerChannel.invokeMethod(EMSDKMethod.getImPushConfigs);
  ...
  Future<EMImPushConfigs> getImPushConfigsFromServer() async{
    Map result = await _emPushManagerChannel.invokeMethod(EMSDKMethod.getImPushConfigsFromServer);
    EMError.hasErrorFromResult(result);
  ...
  Future<bool> updatePushNickname (String nickname) async{
    ...
    Map result = await _emPushManagerChannel.invokeMethod(EMSDKMethod.updatePushNickname, req);
    EMError.hasErrorFromResult(result);
