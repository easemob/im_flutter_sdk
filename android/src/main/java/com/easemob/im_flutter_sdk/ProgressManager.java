...
public class ProgressManager extends Wrapper implements MethodChannel.MethodCallHandler {

    public ProgressManager(FlutterPlugin.FlutterPluginBinding flutterPluginBinding, String channelName) {
